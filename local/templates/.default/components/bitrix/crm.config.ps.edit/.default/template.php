	...
	<table width="100%" class="bx-settings-table">
		<tbody id="PS_INFO">
			...
			<tr>
				...
				<td class="bx-field-value"><input type="text" name="NAME" value="<?=$arResult['PAY_SYSTEM']['NAME'] ?: ''?>"></td>
			</tr>
			<tr>
			...
			<tr>
				...
				<td class="bx-field-value"><textarea name="DESCRIPTION" cols="40" rows="3"><?=$arResult['PAY_SYSTEM']['DESCRIPTION'] ?: ''?></textarea></td>
			</tr>
			<tr>
