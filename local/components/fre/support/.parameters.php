...
try
{
	if (!Main\Loader::includeModule('iblock'))
		throw new Main\LoaderException(Loc::getMessage('SUPPORT_PARAMETERS_IBLOCK_MODULE_NOT_INSTALLED'));
	...
	$arComponentParameters = array(
		...
		'PARAMETERS' => array(
			"IBLOCK_TYPE" => Array(
				"PARENT" => "BASE",
				"NAME" => GetMessage("SUPPORT_PARAMETERS_IBLOCK_TYPE"),
				"TYPE" => "LIST",
				"VALUES" => $arTypesEx,
				"DEFAULT" => "news",
				"REFRESH" => "Y",
			...
			"IBLOCK_ID" => Array(
				"PARENT" => "BASE",
				"NAME" => GetMessage("SUPPORT_PARAMETERS_IBLOCK_ID"),
				"TYPE" => "LIST",
				"VALUES" => $arIBlocks,
				"DEFAULT" => '={$_REQUEST["ID"]}',
				"ADDITIONAL_VALUES" => "Y",
			...
			'SEF_MODE' => array(
	            'index' => array(
	                'NAME' => GetMessage('SUPPORT_PARAMETERS_INDEX_PAGE'),
	                'DEFAULT' => '',
	                'VARIABLES' => array()
	            ),
				'section' => array(
					"NAME" => "Страница раздела",
					"DEFAULT" => "section/#SECTION_ID#/",
	            ...
	            'ticket' => array(
	            	"NAME" => GetMessage('SUPPORT_PARAMETERS_DETAIL_PAGE'),
	                "DEFAULT" => 'ticket/#TICKET_ID#/',
	                "VARIABLES" => array('TICKET_ID')
				)
	        ),
			'CACHE_TIME' => array(
				'DEFAULT' => 3600
