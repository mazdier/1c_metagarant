...
$MESS["CRM_DEAL_REBUILD_STATISTICS"] = "Для правильной работы отчётов необходимо <a id=\"#ID#\" href=\"#URL#\">произвести обновление</a> статистистики для сделок.";
$MESS["CRM_DEAL_REBUILD_STATISTICS_DLG_TITLE"] = "Обновление статистики для сделок";
$MESS["CRM_DEAL_REBUILD_STATISTICS_DLG_SUMMARY"] = "Будет произведено обновление статистики для сделок. Выполнение этой операции может занять продолжительное время.";
