...
$prefixLower="contact_actions_grid";
$arResult['ENABLE_WEBDAV']="";
$arResult['ENABLE_DISK']=1;
$arResult['OWNER_TYPE']=$arParams["ENTITY_COMMUNICATIONS"]["OWNER_TYPE"];
$arResult['OWNER_ID']=$arParams["ENTITY_COMMUNICATIONS"]["OWNER_ID"];
$editorCfg = array(
	'type' => $type,
	'serviceUrl' => '/local/components/sw/crm.activity.editor/ajax.php?siteID='.SITE_ID.'&'.bitrix_sessid_get(),
...
<?endif;?>
<!--Hidden container is used in dialogs-->
<div id="<?= $editorCfg['callClockID'] ?>" style="">
...
?></div>
<!--Hidden container is used in dialogs-->
<div id="<?= $editorCfg['meetingClockID'] ?>" style="">
<script type="text/javascript">
	(function()
		{
...
// echo "<pre>";print_r($editorCfg);echo "</pre>";
