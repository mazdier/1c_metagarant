...
$rsSects = CIBlockSection::GetList(array('left_margin' => 'asc'), $arFilters, false, array("UF_PHONE_INNER"));
...
<form name="form2" action="" method="GET">
    ...
    foreach ($mas['dep'] as $key => $value)
    {
		...
		if ($value["DEPTH_LEVEL"] == 5)
        {
            $dep["REFERENCE"][] = "••• " . $value["NAME"];
        }*/

		$dep["REFERENCE"][] = $value["DEPTH_LEVEL"].".". $value["NAME"];
        $dep["REFERENCE_ID"][] = $value["UF_PHONE_INNER"];
	...
	$CHOICE = 0;
    echo SelectBoxFromArray("DEP", $dep, $CHOICE, "", "class=\"bxhtmled-top-bar-select\"", false, "form2");
    ?>
</form>
